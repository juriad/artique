<h2>Shortcuts dialog</h2>

<img src="15.png">

User may create and manage his own set of shortcuts.

<h3>Types</h3>

Shortcuts are of three different types:
<ul>
	<li>Actions.
...
In Shortcuts dialog, all existing shortcuts are shown: the key stroke they are activated by, their type and the action the perform or object they use.

<h3>Actions</h3>

The user may create a new action shortcut by clicking Add action shortcut button.
An Action shortcut dialog will be shown.

The other operation, the user may perform, is to delete any of existing shortcuts by selecting it and clicking Delete button.
...
<ul>
	<li>modifiers are specified as their first letter in Uppercase separated by plus sign from the rest of key stroke.
		...
		<br>
		Examples:
		<kbd>C+a</kbd>, <kbd>a</kbd>, <kbd>CA+a</kbd>
	</li>
	<li>the name of key is letter, symbol, number or its name.
		<br>
		Examples:
		<kbd>a</kbd>, <kbd>=</kbd>, <kbd>1</kbd>, <kbd>tab</kbd>
	</li>
</ul>
