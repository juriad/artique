...
<ul>
	...
	<li>Page change — checks periodically whether content of the page has changed since last visit.</li>
...
<ul>
	...
	<li>Watching – whether the source is being watched (active) or not (disabled).
		The user will not be notified about new items of disabled source.</li>
	<li>Hierarchy – path to root; folder names separated by slashes.</li>
	<li>Default labels – labels which are automatically assigned to a new item of the source.</li>
	<li>Region (only if HTML source) – Specifies what area on the page shall be processed and what area shall be skipped.</li>
	<li>Last check – date when the source was last checked.</li>
	<li>Errors – number of errors since last successful check.</li>
	<li>Next check – date of next planned check. The user may force immediate check.</li>
</ul>
