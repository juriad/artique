...
It is a simpified version of Filter detail dialog which lacks persistent information.

User may set following criteria:
<ul>
	<li>Query consting of labels combined by logical operators AND and OR.
		Remmember that, each source has also a label with the same name.
		Operator AND (or no operator) has higher precedence than operator OR.
		No grouping by parenthensis is supported.
		</li>
	<li>Date criteria (From, To) specifies date range of when the item must have been added to be matched by this criterion.</li>
	<li>Read criterion – whether to show read or unread items only.</li>
</ul>
