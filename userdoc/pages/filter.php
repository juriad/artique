...
User create a new filter or save current filter via Filter dialog.
This dialog is extended version of Ad-hoc dialog.

The filter has following attributes:
<ul>
	<li>Name – name of the filter; user may change the name.</li>
	<li>Hierarchy – path to root; folder names separated by slashes.</li>
	<li>Export alias (optional) – if alias is defined, items matching this filter are publicaly available as a RSS or Atom feed.
