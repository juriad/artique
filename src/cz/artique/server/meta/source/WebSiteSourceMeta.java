...
/** */
public final class WebSiteSourceMeta
		extends
		org.slim3.datastore.ModelMeta<cz.artique.shared.model.source.WebSiteSource> {

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, com.google.appengine.api.datastore.Key> region =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, com.google.appengine.api.datastore.Key>(
			this, "region", "region",
			com.google.appengine.api.datastore.Key.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, java.lang.Boolean> enabled =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, java.lang.Boolean>(
			this, "enabled", "enabled", boolean.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, java.lang.Boolean> enqued =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, java.lang.Boolean>(
			this, "enqued", "enqued", boolean.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, java.lang.Integer> errorSequence =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, java.lang.Integer>(
			this, "errorSequence", "errorSequence", int.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, com.google.appengine.api.datastore.Key> key =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, com.google.appengine.api.datastore.Key>(
			this, "__key__", "key",
			com.google.appengine.api.datastore.Key.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, java.util.Date> lastCheck =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, java.util.Date>(
			this, "lastCheck", "lastCheck", java.util.Date.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, java.util.Date> nextCheck =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, java.util.Date>(
			this, "nextCheck", "nextCheck", java.util.Date.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, com.google.appengine.api.datastore.Key> parent =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, com.google.appengine.api.datastore.Key>(
			this, "parent", "parent",
			com.google.appengine.api.datastore.Key.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, com.google.appengine.api.datastore.Link> url =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, com.google.appengine.api.datastore.Link>(
			this, "url", "url", com.google.appengine.api.datastore.Link.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, java.lang.Integer> usage =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, java.lang.Integer>(
			this, "usage", "usage", int.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, java.lang.Long> version =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.WebSiteSource, java.lang.Long>(
			this, "version", "version", java.lang.Long.class);

	private static final WebSiteSourceMeta slim3_singleton =
		new WebSiteSourceMeta();
	...
	public WebSiteSourceMeta() {
		super("Source", cz.artique.shared.model.source.WebSiteSource.class,
			java.util.Arrays.asList(
				"cz.artique.shared.model.source.HTMLSource",
				"cz.artique.shared.model.source.WebSiteSource"));
	}

	@Override
	public cz.artique.shared.model.source.WebSiteSource entityToModel(
			com.google.appengine.api.datastore.Entity entity) {
		cz.artique.shared.model.source.WebSiteSource model =
			new cz.artique.shared.model.source.WebSiteSource();
		...
		model.setUrl((com.google.appengine.api.datastore.Link) entity
			.getProperty("url"));
		model.setUsage(longToPrimitiveInt((java.lang.Long) entity
			.getProperty("usage")));
	...
	public com.google.appengine.api.datastore.Entity modelToEntity(
		...
		cz.artique.shared.model.source.WebSiteSource m =
			(cz.artique.shared.model.source.WebSiteSource) model;
	...
	@Override
	protected cz.artique.shared.model.source.WebSiteSource jsonToModel(
		...
		m.setParentObject(decoder0.decode(reader, m.getParentObject(),
