...
/** */
public final class RegionMeta
		extends
		org.slim3.datastore.ModelMeta<cz.artique.shared.model.source.Region> {
	...
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.Region, com.google.appengine.api.datastore.Key> htmlSource =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.Region, com.google.appengine.api.datastore.Key>(
			this, "htmlSource", "htmlSource",
			com.google.appengine.api.datastore.Key.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.Region, com.google.appengine.api.datastore.Key> key =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.Region, com.google.appengine.api.datastore.Key>(
			this, "__key__", "key",
			com.google.appengine.api.datastore.Key.class);

	/** */
	public final org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.source.Region> name =
		new org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.source.Region>(
			this, "name", "name");
	...
	public final org.slim3.datastore.StringCollectionUnindexedAttributeMeta<cz.artique.shared.model.source.Region, java.util.List<java.lang.String>> negativeSelectors =
		new org.slim3.datastore.StringCollectionUnindexedAttributeMeta<cz.artique.shared.model.source.Region, java.util.List<java.lang.String>>(
			this, "negativeSelectors", "negativeSelectors",
			java.util.List.class);

	/** */
	public final org.slim3.datastore.StringUnindexedAttributeMeta<cz.artique.shared.model.source.Region> positiveSelector =
		new org.slim3.datastore.StringUnindexedAttributeMeta<cz.artique.shared.model.source.Region>(
			this, "positiveSelector", "positiveSelector");

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.Region, cz.artique.shared.model.source.RegionType> type =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.Region, cz.artique.shared.model.source.RegionType>(
			this, "type", "type",
			cz.artique.shared.model.source.RegionType.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.Region, java.lang.Long> version =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.Region, java.lang.Long>(
	...
	@Override
	public cz.artique.shared.model.source.Region entityToModel(
			com.google.appengine.api.datastore.Entity entity) {
		cz.artique.shared.model.source.Region model =
			new cz.artique.shared.model.source.Region();
		model.setHtmlSource((com.google.appengine.api.datastore.Key) entity
			.getProperty("htmlSource"));
		model.setKey(entity.getKey());
		model.setName((java.lang.String) entity.getProperty("name"));
		model.setNegativeSelectors(toList(java.lang.String.class,
			entity.getProperty("negativeSelectors")));
		model.setPositiveSelector((java.lang.String) entity
			.getProperty("positiveSelector"));
	...
	public com.google.appengine.api.datastore.Entity modelToEntity(
		...
		cz.artique.shared.model.source.Region m =
			(cz.artique.shared.model.source.Region) model;
		...
		entity.setUnindexedProperty("negativeSelectors",
			m.getNegativeSelectors());
		entity
			.setUnindexedProperty("positiveSelector", m.getPositiveSelector());
	...
	@Override
	protected cz.artique.shared.model.source.Region jsonToModel(
		...
		reader = rootReader.newObjectReader("negativeSelectors");
		{
			...
			org.slim3.datastore.json.JsonArrayReader r =
				rootReader.newArrayReader("negativeSelectors");
			if (r != null) {
				reader = r;
				int n = r.length();
				for (int i = 0; i < n; i++) {
					r.setIndex(i);
					java.lang.String v =
						decoder0.decode(reader, (java.lang.String) null);
					if (v != null) {
						elements.add(v);
					}
				}
