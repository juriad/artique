...
public final class ManualSourceMeta
		extends
		org.slim3.datastore.ModelMeta<cz.artique.shared.model.source.ManualSource> {

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, com.google.appengine.api.users.User> user =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, com.google.appengine.api.users.User>(
	...
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, java.lang.Integer> errorSequence =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, java.lang.Integer>(
			this, "errorSequence", "errorSequence", int.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, com.google.appengine.api.datastore.Key> key =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, com.google.appengine.api.datastore.Key>(
			this, "__key__", "key",
			com.google.appengine.api.datastore.Key.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, java.util.Date> lastCheck =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, java.util.Date>(
			this, "lastCheck", "lastCheck", java.util.Date.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, java.util.Date> nextCheck =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, java.util.Date>(
			this, "nextCheck", "nextCheck", java.util.Date.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, com.google.appengine.api.datastore.Key> parent =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, com.google.appengine.api.datastore.Key>(
			this, "parent", "parent",
			com.google.appengine.api.datastore.Key.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, com.google.appengine.api.datastore.Link> url =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, com.google.appengine.api.datastore.Link>(
			this, "url", "url", com.google.appengine.api.datastore.Link.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, java.lang.Integer> usage =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, java.lang.Integer>(
			this, "usage", "usage", int.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, java.lang.Long> version =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.source.ManualSource, java.lang.Long>(
			this, "version", "version", java.lang.Long.class);

	private static final ManualSourceMeta slim3_singleton =
		new ManualSourceMeta();
	...
	public ManualSourceMeta() {
		super("Source", cz.artique.shared.model.source.ManualSource.class,
			java.util.Arrays
				.asList("cz.artique.shared.model.source.ManualSource"));
	}

	@Override
	public cz.artique.shared.model.source.ManualSource entityToModel(
			com.google.appengine.api.datastore.Entity entity) {
		cz.artique.shared.model.source.ManualSource model =
			new cz.artique.shared.model.source.ManualSource();
	...
	public com.google.appengine.api.datastore.Entity modelToEntity(
		...
		cz.artique.shared.model.source.ManualSource m =
			(cz.artique.shared.model.source.ManualSource) model;
	...
	@Override
	protected cz.artique.shared.model.source.ManualSource jsonToModel(
