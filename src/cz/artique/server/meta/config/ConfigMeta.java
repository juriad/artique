...
public final class ConfigMeta
		extends
		org.slim3.datastore.ModelMeta<cz.artique.shared.model.config.Config> {

	/** */
	public final org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.config.Config> configKey =
		new org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.config.Config>(
			this, "configKey", "configKey");

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.config.Config, java.lang.Double> doubleValue =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.config.Config, java.lang.Double>(
			this, "doubleValue", "doubleValue", double.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.config.Config, java.lang.Integer> intValue =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.config.Config, java.lang.Integer>(
			this, "intValue", "intValue", int.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.config.Config, com.google.appengine.api.datastore.Key> key =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.config.Config, com.google.appengine.api.datastore.Key>(
			this, "__key__", "key",
			com.google.appengine.api.datastore.Key.class);

	/** */
	public final org.slim3.datastore.StringUnindexedAttributeMeta<cz.artique.shared.model.config.Config> stringValue =
		new org.slim3.datastore.StringUnindexedAttributeMeta<cz.artique.shared.model.config.Config>(
			this, "stringValue", "stringValue");

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.config.Config, java.lang.Long> version =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.config.Config, java.lang.Long>(
	...
	@Override
	public cz.artique.shared.model.config.Config entityToModel(
			com.google.appengine.api.datastore.Entity entity) {
		cz.artique.shared.model.config.Config model =
			new cz.artique.shared.model.config.Config();
	...
	public com.google.appengine.api.datastore.Entity modelToEntity(
		...
		cz.artique.shared.model.config.Config m =
			(cz.artique.shared.model.config.Config) model;
	...
	@Override
	protected cz.artique.shared.model.config.Config jsonToModel(
