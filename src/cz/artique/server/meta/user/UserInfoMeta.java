...
public final class UserInfoMeta
		extends
		org.slim3.datastore.ModelMeta<cz.artique.shared.model.user.UserInfo> {

	/** */
	public final org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.user.UserInfo> clientToken =
		new org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.user.UserInfo>(
			this, "clientToken", "clientToken");

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.user.UserInfo, com.google.appengine.api.datastore.Key> key =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.user.UserInfo, com.google.appengine.api.datastore.Key>(
			this, "__key__", "key",
			com.google.appengine.api.datastore.Key.class);

	/** */
	public final org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.user.UserInfo> nickname =
		new org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.user.UserInfo>(
			this, "nickname", "nickname");

	/** */
	public final org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.user.UserInfo> userId =
		new org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.user.UserInfo>(
			this, "userId", "userId");

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.user.UserInfo, java.lang.Long> version =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.user.UserInfo, java.lang.Long>(
	...
	@Override
	public cz.artique.shared.model.user.UserInfo entityToModel(
			com.google.appengine.api.datastore.Entity entity) {
		cz.artique.shared.model.user.UserInfo model =
			new cz.artique.shared.model.user.UserInfo();
		model.setClientToken((java.lang.String) entity
	...
	public com.google.appengine.api.datastore.Entity modelToEntity(
		...
		cz.artique.shared.model.user.UserInfo m =
			(cz.artique.shared.model.user.UserInfo) model;
	...
	@Override
	protected cz.artique.shared.model.user.UserInfo jsonToModel(
