...
public final class FilterMeta
	...
	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.Filter, cz.artique.shared.model.label.FilterLevel> level =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.Filter, cz.artique.shared.model.label.FilterLevel>(
			this, "level", "level",
			cz.artique.shared.model.label.FilterLevel.class);

	/** */
	public final org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.label.Filter> userId =
	...
	public cz.artique.shared.model.label.Filter entityToModel(
		...
		model.setLevel(stringToEnum(
			cz.artique.shared.model.label.FilterLevel.class,
			(java.lang.String) entity.getProperty("level")));
