...
public final class ExportMeta
		extends
		org.slim3.datastore.ModelMeta<cz.artique.shared.model.label.Export> {

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.Export, com.google.appengine.api.datastore.Key> key =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.Export, com.google.appengine.api.datastore.Key>(
			this, "__key__", "key",
			com.google.appengine.api.datastore.Key.class);

	/** */
	public final org.slim3.datastore.CollectionAttributeMeta<cz.artique.shared.model.label.Export, java.util.List<com.google.appengine.api.datastore.Key>, com.google.appengine.api.datastore.Key> labels =
		new org.slim3.datastore.CollectionAttributeMeta<cz.artique.shared.model.label.Export, java.util.List<com.google.appengine.api.datastore.Key>, com.google.appengine.api.datastore.Key>(
			this, "labels", "labels", java.util.List.class);

	/** */
	public final org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.label.Export> name =
		new org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.label.Export>(
			this, "name", "name");

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.Export, cz.artique.shared.model.label.Operator> operator =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.Export, cz.artique.shared.model.label.Operator>(
			this, "operator", "operator",
			cz.artique.shared.model.label.Operator.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.Export, com.google.appengine.api.datastore.Key> parent =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.Export, com.google.appengine.api.datastore.Key>(
			this, "parent", "parent",
			com.google.appengine.api.datastore.Key.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.Export, com.google.appengine.api.users.User> user =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.Export, com.google.appengine.api.users.User>(
			this, "user", "user", com.google.appengine.api.users.User.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.Export, java.lang.Long> version =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.Export, java.lang.Long>(
			this, "version", "version", java.lang.Long.class);

	private static final ExportMeta slim3_singleton = new ExportMeta();

	/**
	 * @return the singleton
	 */
	public static ExportMeta get() {
		return slim3_singleton;
	}

	/** */
	public ExportMeta() {
		super("Filter", cz.artique.shared.model.label.Export.class,
			java.util.Arrays.asList("cz.artique.shared.model.label.Export"));
	}

	@Override
	public cz.artique.shared.model.label.Export entityToModel(
			com.google.appengine.api.datastore.Entity entity) {
		cz.artique.shared.model.label.Export model =
			new cz.artique.shared.model.label.Export();
	...
	public com.google.appengine.api.datastore.Entity modelToEntity(
		...
		cz.artique.shared.model.label.Export m =
			(cz.artique.shared.model.label.Export) model;
	...
	@Override
	protected cz.artique.shared.model.label.Export jsonToModel(
