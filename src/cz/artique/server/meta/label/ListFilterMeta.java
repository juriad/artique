...
/** */
public final class ListFilterMeta
		extends
		org.slim3.datastore.ModelMeta<cz.artique.shared.model.label.ListFilter> {

	/** */
	public final org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.label.ListFilter, java.util.Date> endTo =
		new org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.label.ListFilter, java.util.Date>(
			this, "endTo", "endTo", java.util.Date.class);

	/** */
	public final org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.label.ListFilter> exportAlias =
		new org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.label.ListFilter>(
			this, "exportAlias", "exportAlias");

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.ListFilter, com.google.appengine.api.datastore.Key> filter =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.ListFilter, com.google.appengine.api.datastore.Key>(
			this, "filter", "filter",
			com.google.appengine.api.datastore.Key.class);

	/** */
	public final org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.label.ListFilter> hierarchy =
		new org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.label.ListFilter>(
			this, "hierarchy", "hierarchy");

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.ListFilter, com.google.appengine.api.datastore.Key> key =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.ListFilter, com.google.appengine.api.datastore.Key>(
			this, "__key__", "key",
			com.google.appengine.api.datastore.Key.class);

	/** */
	public final org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.label.ListFilter> name =
		new org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.label.ListFilter>(
			this, "name", "name");

	/** */
	public final org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.label.ListFilter, cz.artique.shared.model.label.ListFilterOrder> order =
		new org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.label.ListFilter, cz.artique.shared.model.label.ListFilterOrder>(
			this, "order", "order",
			cz.artique.shared.model.label.ListFilterOrder.class);

	/** */
	public final org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.label.ListFilter, java.lang.Boolean> read =
		new org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.label.ListFilter, java.lang.Boolean>(
			this, "read", "read", java.lang.Boolean.class);

	/** */
	public final org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.label.ListFilter, java.util.Date> startFrom =
		new org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.label.ListFilter, java.util.Date>(
			this, "startFrom", "startFrom", java.util.Date.class);

	/** */
	public final org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.label.ListFilter> userId =
		new org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.label.ListFilter>(
			this, "userId", "userId");

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.ListFilter, java.lang.Long> version =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.label.ListFilter, java.lang.Long>(
	...
	@Override
	public cz.artique.shared.model.label.ListFilter entityToModel(
			com.google.appengine.api.datastore.Entity entity) {
		cz.artique.shared.model.label.ListFilter model =
			new cz.artique.shared.model.label.ListFilter();
		model.setEndTo((java.util.Date) entity.getProperty("endTo"));
		model.setExportAlias((java.lang.String) entity
			.getProperty("exportAlias"));
		model.setFilter((com.google.appengine.api.datastore.Key) entity
			.getProperty("filter"));
		model.setHierarchy((java.lang.String) entity.getProperty("hierarchy"));
		model.setKey(entity.getKey());
		model.setName((java.lang.String) entity.getProperty("name"));
		model.setOrder(stringToEnum(
			cz.artique.shared.model.label.ListFilterOrder.class,
			(java.lang.String) entity.getProperty("order")));
	...
	public com.google.appengine.api.datastore.Entity modelToEntity(
		...
		cz.artique.shared.model.label.ListFilter m =
			(cz.artique.shared.model.label.ListFilter) model;
	...
	@Override
	protected cz.artique.shared.model.label.ListFilter jsonToModel(
		...
		m.setFilterObject(decoder0.decode(reader, m.getFilterObject(),
			cz.artique.shared.model.label.Filter.class));
		...
		m.setOrder(decoder0.decode(reader, m.getOrder(),
			cz.artique.shared.model.label.ListFilterOrder.class));
