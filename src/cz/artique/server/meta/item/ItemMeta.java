...
//@javax.annotation.Generated(value = { "slim3-gen", "@VERSION@" }, date = "2012-11-17 18:34:02")
/** */
public final class ItemMeta extends org.slim3.datastore.ModelMeta<cz.artique.shared.model.item.Item> {
    ...
    /** */
    public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.Item, cz.artique.shared.model.item.ItemType> itemType = new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.Item, cz.artique.shared.model.item.ItemType>(this, "itemType", "itemType", cz.artique.shared.model.item.ItemType.class);
    ...
    public cz.artique.shared.model.item.Item entityToModel(com.google.appengine.api.datastore.Entity entity) {
        cz.artique.shared.model.item.Item model = new cz.artique.shared.model.item.Item();
    ...
    protected cz.artique.shared.model.item.Item jsonToModel(org.slim3.datastore.json.JsonRootReader rootReader, int maxDepth, int currentDepth) {
        cz.artique.shared.model.item.Item m = new cz.artique.shared.model.item.Item();
