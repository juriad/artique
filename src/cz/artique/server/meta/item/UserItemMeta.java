...
/** */
public final class UserItemMeta
		extends
		org.slim3.datastore.ModelMeta<cz.artique.shared.model.item.UserItem> {

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.UserItem, java.util.Date> added =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.UserItem, java.util.Date>(
			this, "added", "added", java.util.Date.class);

	/** */
	public final org.slim3.datastore.StringUnindexedAttributeMeta<cz.artique.shared.model.item.UserItem> backupBlobKey =
		new org.slim3.datastore.StringUnindexedAttributeMeta<cz.artique.shared.model.item.UserItem>(
			this, "backupBlobKey", "backupBlobKey");

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.UserItem, com.google.appengine.api.datastore.Key> item =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.UserItem, com.google.appengine.api.datastore.Key>(
			this, "item", "item", com.google.appengine.api.datastore.Key.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.UserItem, com.google.appengine.api.datastore.Key> key =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.UserItem, com.google.appengine.api.datastore.Key>(
			this, "__key__", "key",
			com.google.appengine.api.datastore.Key.class);

	/** */
	public final org.slim3.datastore.CollectionAttributeMeta<cz.artique.shared.model.item.UserItem, java.util.List<com.google.appengine.api.datastore.Key>, com.google.appengine.api.datastore.Key> labels =
		new org.slim3.datastore.CollectionAttributeMeta<cz.artique.shared.model.item.UserItem, java.util.List<com.google.appengine.api.datastore.Key>, com.google.appengine.api.datastore.Key>(
			this, "labels", "labels", java.util.List.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.UserItem, java.util.Date> lastChanged =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.UserItem, java.util.Date>(
			this, "lastChanged", "lastChanged", java.util.Date.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.UserItem, java.lang.Boolean> read =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.UserItem, java.lang.Boolean>(
			this, "read", "read", boolean.class);

	/** */
	public final org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.item.UserItem> userId =
		new org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.item.UserItem>(
			this, "userId", "userId");

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.UserItem, com.google.appengine.api.datastore.Key> userSource =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.UserItem, com.google.appengine.api.datastore.Key>(
			this, "userSource", "userSource",
			com.google.appengine.api.datastore.Key.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.UserItem, java.lang.Long> version =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.UserItem, java.lang.Long>(
	...
	@Override
	public cz.artique.shared.model.item.UserItem entityToModel(
			com.google.appengine.api.datastore.Entity entity) {
		cz.artique.shared.model.item.UserItem model =
			new cz.artique.shared.model.item.UserItem();
		model.setAdded((java.util.Date) entity.getProperty("added"));
		model.setBackupBlobKey((java.lang.String) entity
			.getProperty("backupBlobKey"));
		model.setItem((com.google.appengine.api.datastore.Key) entity
			.getProperty("item"));
		model.setKey(entity.getKey());
		model.setLabels(toList(com.google.appengine.api.datastore.Key.class,
			entity.getProperty("labels")));
		model
			.setLastChanged((java.util.Date) entity.getProperty("lastChanged"));
		model.setRead(booleanToPrimitiveBoolean((java.lang.Boolean) entity
			.getProperty("read")));
		model.setUserId((java.lang.String) entity.getProperty("userId"));
		model.setUserSource((com.google.appengine.api.datastore.Key) entity
			.getProperty("userSource"));
	...
	public com.google.appengine.api.datastore.Entity modelToEntity(
		...
		cz.artique.shared.model.item.UserItem m =
			(cz.artique.shared.model.item.UserItem) model;
	...
	@Override
	protected cz.artique.shared.model.item.UserItem jsonToModel(
		...
		m.setItemObject(decoder0.decode(reader, m.getItemObject(),
			cz.artique.shared.model.item.Item.class));
