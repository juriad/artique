...
//@javax.annotation.Generated(value = { "slim3-gen", "@VERSION@" }, date = "2013-06-11 12:49:26")
/** */
public final class PageChangeItemMeta extends org.slim3.datastore.ModelMeta<cz.artique.shared.model.item.PageChangeItem> {

    /** */
    public final org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.item.PageChangeItem, java.util.Date> comparedTo = new org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.item.PageChangeItem, java.util.Date>(this, "comparedTo", "comparedTo", java.util.Date.class);
    ...
    /** */
    public final org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.item.PageChangeItem, cz.artique.shared.model.item.ContentType> diffType = new org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.item.PageChangeItem, cz.artique.shared.model.item.ContentType>(this, "diffType", "diffType", cz.artique.shared.model.item.ContentType.class);

    /** */
    public final org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.item.PageChangeItem, java.util.Date> added = new org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.item.PageChangeItem, java.util.Date>(this, "added", "added", java.util.Date.class);
    ...
    /** */
    public final org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.item.PageChangeItem, cz.artique.shared.model.item.ContentType> contentType = new org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.item.PageChangeItem, cz.artique.shared.model.item.ContentType>(this, "contentType", "contentType", cz.artique.shared.model.item.ContentType.class);
    ...
    /** */
    public final org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.item.PageChangeItem, java.util.Date> published = new org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.item.PageChangeItem, java.util.Date>(this, "published", "published", java.util.Date.class);
    ...
    /** */
    public final org.slim3.datastore.StringUnindexedAttributeMeta<cz.artique.shared.model.item.PageChangeItem> title = new org.slim3.datastore.StringUnindexedAttributeMeta<cz.artique.shared.model.item.PageChangeItem>(this, "title", "title");

    /** */
    public final org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.item.PageChangeItem, com.google.appengine.api.datastore.Link> url = new org.slim3.datastore.CoreUnindexedAttributeMeta<cz.artique.shared.model.item.PageChangeItem, com.google.appengine.api.datastore.Link>(this, "url", "url", com.google.appengine.api.datastore.Link.class);
