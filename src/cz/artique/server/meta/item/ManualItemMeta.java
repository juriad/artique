...
//@javax.annotation.Generated(value = { "slim3-gen", "@VERSION@" }, date = "2012-11-17 21:31:02")
/** */
public final class ManualItemMeta extends org.slim3.datastore.ModelMeta<cz.artique.shared.model.item.ManualItem> {
    ...
    /** */
    public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.ManualItem, cz.artique.shared.model.item.ItemType> itemType = new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.item.ManualItem, cz.artique.shared.model.item.ItemType>(this, "itemType", "itemType", cz.artique.shared.model.item.ItemType.class);
