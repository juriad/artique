...
/** */
public final class ShortcutMeta
		extends
		org.slim3.datastore.ModelMeta<cz.artique.shared.model.shortcut.Shortcut> {

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.shortcut.Shortcut, cz.artique.shared.model.shortcut.ShortcutAction> action =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.shortcut.Shortcut, cz.artique.shared.model.shortcut.ShortcutAction>(
			this, "action", "action",
			cz.artique.shared.model.shortcut.ShortcutAction.class);

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.shortcut.Shortcut, com.google.appengine.api.datastore.Key> key =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.shortcut.Shortcut, com.google.appengine.api.datastore.Key>(
			this, "__key__", "key",
			com.google.appengine.api.datastore.Key.class);

	/** */
	public final org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.shortcut.Shortcut> keyStroke =
		new org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.shortcut.Shortcut>(
	...
	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.shortcut.Shortcut, cz.artique.shared.model.shortcut.ShortcutType> type =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.shortcut.Shortcut, cz.artique.shared.model.shortcut.ShortcutType>(
			this, "type", "type",
			cz.artique.shared.model.shortcut.ShortcutType.class);

	/** */
	public final org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.shortcut.Shortcut> userId =
		new org.slim3.datastore.StringAttributeMeta<cz.artique.shared.model.shortcut.Shortcut>(
			this, "userId", "userId");

	/** */
	public final org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.shortcut.Shortcut, java.lang.Long> version =
		new org.slim3.datastore.CoreAttributeMeta<cz.artique.shared.model.shortcut.Shortcut, java.lang.Long>(
	...
	@Override
	public cz.artique.shared.model.shortcut.Shortcut entityToModel(
			com.google.appengine.api.datastore.Entity entity) {
		cz.artique.shared.model.shortcut.Shortcut model =
			new cz.artique.shared.model.shortcut.Shortcut();
		model.setAction(stringToEnum(
			cz.artique.shared.model.shortcut.ShortcutAction.class,
			(java.lang.String) entity.getProperty("action")));
		model.setKey(entity.getKey());
		model.setKeyStroke((java.lang.String) entity.getProperty("keyStroke"));
		model.setReferenced((com.google.appengine.api.datastore.Key) entity
	...
	public com.google.appengine.api.datastore.Entity modelToEntity(
		...
		cz.artique.shared.model.shortcut.Shortcut m =
			(cz.artique.shared.model.shortcut.Shortcut) model;
	...
	@Override
	protected cz.artique.shared.model.shortcut.Shortcut jsonToModel(
		...
		m.setReferencedLabel(decoder0.decode(reader, m.getReferencedLabel(),
			cz.artique.shared.model.label.Label.class));
		reader = rootReader.newObjectReader("referencedListFilter");
		m.setReferencedListFilter(decoder0.decode(reader,
			m.getReferencedListFilter(),
			cz.artique.shared.model.label.ListFilter.class));
